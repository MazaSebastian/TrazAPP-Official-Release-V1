...
const primaryButtonStyle = { background: 'rgba(var(--primary-color-rgb, 168, 85, 247), 0.2)', color: '#d8b4fe', border: '1px solid rgba(var(--primary-color-rgb, 168, 85, 247), 0.5)', padding: '0.75rem 2rem', borderRadius: '0.5rem', fontWeight: 700, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '1rem', backdropFilter: 'blur(8px)', transition: 'all 0.2s', boxShadow: '0 4px 6px rgba(0,0,0,0.2)' };
